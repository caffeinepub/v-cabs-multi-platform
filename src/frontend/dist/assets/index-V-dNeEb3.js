...
var ve = (n) => {
  ...
  }, [t.closeButton, et]), Tt = React2.useMemo(() => t.duration || X || Wt, [t.duration, X]), gt = React2.useRef(0), U2 = React2.useRef(0), St = React2.useRef(0), K = React2.useRef(null), [Gt, Qt] = st.split("-"), Rt = React2.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
  ...
  function Zt() {
    var r2, m, c;
    return P != null && P.loading ? React2.createElement("div", { className: M(s == null ? void 0 : s.loader, (r2 = t == null ? void 0 : t.classNames) == null ? void 0 : r2.loader, "sonner-loader"), "data-visible": N === "loading" }, P.loading) : rt ? React2.createElement("div", { className: M(s == null ? void 0 : s.loader, (m = t == null ? void 0 : t.classNames) == null ? void 0 : m.loader, "sonner-loader"), "data-visible": N === "loading" }, rt) : React2.createElement(Yt, { className: M(s == null ? void 0 : s.loader, (c = t == null ? void 0 : t.classNames) == null ? void 0 : c.loader), visible: N === "loading" });
  }
...
function AdminDashboard({
  ...
  const totalRevenue = rides.filter((r2) => r2.status === "completed").reduce((s, r2) => s + r2.fare, 0);
  const activeRides = rides.filter(
    (r2) => ["accepted", "in_progress"].includes(r2.status)
  ).length;
  const ridesByStatus = [
    "pending",
    "accepted",
    ...
    status: s,
    count: rides.filter((r2) => r2.status === s).length,
  ...
  const navItems = [
    ...
    { id: "users", label: "Users", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-4 h-4" }) },
    { id: "rides", label: "Rides", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "w-4 h-4" }) },
    {
      id: "audit",
      label: "Audit Log",
  ...
  const getUserName = (id) => {
    var _a2;
    return ((_a2 = users.find((u) => u.id === id)) == null ? void 0 : _a2.name) ?? id;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-56 bg-sidebar text-sidebar-foreground flex-shrink-0 flex flex-col shadow-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-b border-sidebar-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground font-bold text-sm", children: "V" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: "font-bold text-base",
            style: { fontFamily: "Bricolage Grotesque, sans-serif" },
            children: "V Cabs Admin"
          }
        )
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 p-3 space-y-1", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all ${page === item.id ? "bg-primary text-primary-foreground" : "text-sidebar-foreground/70 hover:text-sidebar-foreground hover:bg-sidebar-accent"}`,
          children: [
            item.icon,
            item.label
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border-t border-sidebar-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-sidebar-foreground/50 truncate", children: currentUser.name }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 overflow-auto", children: [
      page === "dashboard" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "V Cabs platform overview" })
        ] }),
        ...
        ].map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mb-2 ${stat.color}`, children: stat.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Rides by Status" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3", children: ridesByStatus.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground capitalize w-24 flex-shrink-0", children: item.status.replace("_", " ") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 bg-muted rounded-full h-6 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold w-6 text-right", children: item.count })
          ] }, item.status)) })
        ] })
      ] }),
      page === "users" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Role" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "V Coins" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-right", children: "Action" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: users.filter((u) => u.role !== "admin").map((user, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "w-3.5 h-3.5 text-primary" }),
              user.vCoins
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
      ...
      page === "rides" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Rider" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Driver" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Route" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Fare" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Date" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: rides.map((ride) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-xs", children: ride.id.toUpperCase() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm", children: getUserName(ride.riderId) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm", children: ride.driverId ? getUserName(ride.driverId) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "—" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-sm max-w-40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-xs", children: ride.pickup }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "truncate text-xs text-muted-foreground", children: [
                "→ ",
                ride.destination
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-sm font-medium text-primary", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `text-xs px-2 py-1 rounded-full font-medium capitalize ${STATUS_COLORS$1[ride.status]}`,
                children: ride.status.replace("_", " ")
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs text-muted-foreground", children: new Date(ride.createdAt).toLocaleDateString() })
          ] }, ride.id)) })
        ] }) })
      ] }),
      page === "audit" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Admin action history" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: auditLogs.map((log2, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: new Date(log2.timestamp).toLocaleString() })
                ] })
              ] })
            ]
          },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "text-center text-xs text-muted-foreground py-4 border-t border-border mx-6", children: [
        "© ",
...
function DriverApp({
  ...
  const [otpInputs, setOtpInputs] = reactExports.useState({});
  const availableRides = rides.filter((r2) => r2.status === "pending");
  const myTrips = rides.filter(
    (r2) => r2.driverId === currentUser.id && ["accepted", "in_progress"].includes(r2.status)
  );
  const completedTrips = rides.filter(
    (r2) => r2.driverId === currentUser.id && r2.status === "completed"
  );
  const earnings = completedTrips.reduce((sum, r2) => sum + r2.fare, 0);
  const acceptRide = (ride) => {
    onUpdateRide(ride.id, { status: "accepted", driverId: currentUser.id });
    ue.success(`Ride accepted! Head to ${ride.pickup}`);
  };
  const verifyOtp = (ride) => {
    const entered = otpInputs[ride.id] ?? "";
    if (entered === ride.otp) {
      onUpdateRide(ride.id, { status: "in_progress" });
      ue.success("OTP verified! Trip started.");
    } else {
      ue.error("Incorrect OTP. Please try again.");
    }
  };
  const completeTrip = (ride) => {
    onUpdateRide(ride.id, { status: "completed" });
    ue.success(`Trip completed! Earned ${ride.fare} V Coins.`);
  };
  const getRiderName = (riderId) => {
    var _a2;
    return ((_a2 = seedUsers.find((u) => u.id === riderId)) == null ? void 0 : _a2.name) ?? "Rider";
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-sidebar text-sidebar-foreground px-4 py-3 flex items-center justify-between shadow-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "ml-2 bg-green-500/20 text-green-400 border-green-500/30 text-xs gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "w-3 h-3" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sidebar-foreground/70 text-sm hidden sm:block", children: currentUser.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "ghost",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 max-w-2xl mx-auto w-full px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "available", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "w-full mb-6 bg-muted", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "available", className: "space-y-3", children: availableRides.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "w-10 h-10 mx-auto mb-3 text-muted-foreground/40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No available rides right now." })
      ] }) : availableRides.map((ride, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
                  "Rider: ",
                  getRiderName(ride.riderId)
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-primary flex items-center gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: ride.pickup })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "w-4 h-4 text-foreground/40 mt-0.5 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: ride.destination })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "trips", className: "space-y-3", children: myTrips.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "w-10 h-10 mx-auto mb-3 text-muted-foreground/40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No active trips." })
      ] }) : myTrips.map((ride) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground font-mono mb-1", children: [
              "#",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `text-xs px-2 py-1 rounded-full font-medium capitalize ${ride.status === "accepted" ? "bg-blue-100 text-blue-800" : "bg-primary/10 text-primary"}`,
                children: ride.status.replace("_", " ")
              }
            )
          ] }),
        ...
        ride.status === "accepted" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Ask rider for OTP to start trip" }),
        ...
        ride.status === "in_progress" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg bg-primary/10 border border-primary/20 px-3 py-2 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary font-medium", children: "Trip in progress" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "earnings", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-primary/30 bg-primary/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "w-10 h-10 mx-auto mb-2 text-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-1", children: "Total V Coin Balance" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-4xl font-extrabold text-primary",
              style: { fontFamily: "Bricolage Grotesque, sans-serif" },
              children: currentUser.vCoins + earnings
            }
          ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Completed Trips" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3", children: completedTrips.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-4", children: "No completed trips yet." }) : completedTrips.map((ride) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: new Date(ride.createdAt).toLocaleDateString() })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-primary flex items-center gap-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "text-center text-xs text-muted-foreground py-4 border-t border-border", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      ". Built with love using",
      " ",
...
function LoginScreen({ onLogin }) {
  const [role, setRole] = reactExports.useState("rider");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex items-center justify-center bg-gradient-to-br from-sidebar via-[oklch(0.20_0.025_255)] to-[oklch(0.13_0.02_260)] p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full bg-primary/20 blur-[120px] pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "w-full max-w-md relative z-10 border-border/60 shadow-2xl bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-2 pt-8 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-medium", children: "Your Ride, Your Way" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "px-8 pb-8 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs uppercase tracking-widest text-muted-foreground", children: "Sign in as" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-1 bg-muted p-1 rounded-lg", children: ["rider", "driver", "admin"].map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              className: `py-2 px-3 rounded-md text-sm font-semibold transition-all capitalize ${role === r2 ? "bg-primary text-primary-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
              children: r2
            },
            r2
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "username", className: "text-sm font-medium", children: "Email" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "username",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-accent/60 p-4 space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-accent-foreground uppercase tracking-wider", children: [
            "Demo Credentials — ",
            role
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono", children: DEMO_CREDENTIALS[role].username }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono", children: DEMO_CREDENTIALS[role].password }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
function RiderApp({
  ...
  const [estimatedFare, setEstimatedFare] = reactExports.useState(null);
  const [isEstimating, setIsEstimating] = reactExports.useState(false);
  const myRides = rides.filter((r2) => r2.riderId === currentUser.id);
  const estimateFare = () => {
    if (!pickup || !destination) {
      ue.error("Please enter pickup and destination");
      return;
    }
  ...
  const bookRide = () => {
    ...
    const newRide = {
      ...
      fare,
      status: "pending",
      otp: String(Math.floor(1e3 + Math.random() * 9e3)),
    ...
    ue.success("Ride booked! Looking for a driver...");
  };
  const getDriverName = (driverId) => {
    var _a2;
    if (!driverId) return null;
    return ((_a2 = seedUsers.find((u) => u.id === driverId)) == null ? void 0 : _a2.name) ?? "Driver";
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-sidebar text-sidebar-foreground px-4 py-3 flex items-center justify-between shadow-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "ml-2 bg-primary/20 text-primary border-primary/30 text-xs gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "w-3 h-3" }),
          currentUser.vCoins,
          " VC"
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 max-w-2xl mx-auto w-full px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "book", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "w-full mb-6 bg-muted", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "book", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Book Your Ride" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
            ...
            estimatedFare !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between rounded-lg bg-accent/60 px-4 py-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-accent-foreground", children: "Estimated Fare" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-primary flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "w-4 h-4" }),
                " ",
                estimatedFare,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  className: "flex-1",
                  children: isEstimating ? "Estimating..." : "Estimate Fare"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: { height: 200 },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-gradient-to-br from-sidebar/5 to-primary/5 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-8 h-8 mx-auto mb-2 text-primary/40" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Live map will appear here" })
            ] }) })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "rides", className: "space-y-3", children: myRides.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "w-10 h-10 mx-auto mb-3 text-muted-foreground/40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No rides yet. Book your first ride!" })
          ]
        }
      ) : myRides.map((ride, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-foreground/30 mt-1.5 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: ride.destination })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "my-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-primary flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "w-3.5 h-3.5" }),
                " ",
                ride.fare,
                " V Coins"
              ] }),
              ride.driverId && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                "Driver: ",
                getDriverName(ride.driverId)
              ] })
            ] }),
            ride.status === "in_progress" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 rounded-lg bg-primary/10 border border-primary/20 px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-primary font-medium", children: [
              "Trip OTP:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-bold text-sm", children: ride.otp })
            ] }) })
          ] })
        },
        ride.id
...
function App() {
  ...
  const [users, setUsers] = reactExports.useState(seedUsers);
  const [rides, setRides] = reactExports.useState(seedRides);
  const [auditLogs, setAuditLogs] = reactExports.useState(seedAuditLogs);
  const handleLogin = (user) => setCurrentUser(user);
  const handleLogout = () => setCurrentUser(null);
  const addRide = (ride) => setRides((prev) => [ride, ...prev]);
  const updateRide = (rideId, updates) => {
    setRides(
      (prev) => prev.map((r2) => r2.id === rideId ? { ...r2, ...updates } : r2)
    );
  };
  const toggleUserStatus = (userId) => {
    setUsers(
      (prev) => prev.map(
        (u) => u.id === userId ? { ...u, status: u.status === "active" ? "suspended" : "active" } : u
      )
    );
      ...
      setAuditLogs((prev) => [
        {
          id: `a${Date.now()}`,
          action,
          actor: (currentUser == null ? void 0 : currentUser.name) ?? "admin",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    !currentUser ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoginScreen, { onLogin: handleLogin }) : currentUser.role === "rider" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      RiderApp,
      {
        currentUser,
        rides,
    ...
    ) : currentUser.role === "driver" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      DriverApp,
      {
        currentUser,
        rides,
